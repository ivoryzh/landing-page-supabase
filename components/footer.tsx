...
export function Footer() {
    return (
        <footer id="community" className="w-full border-t border-border/40 py-12 bg-muted/20 dark:bg-[#0B0C10]">
