            ...
            <div className="max-w-7xl mx-auto px-4 flex flex-col gap-12">
                <div className="text-center space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <a
                            href="https://www.nature.com/articles/s41467-025-60514-w"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-5 py-2 rounded-lg bg-background border border-foreground/20 text-foreground font-medium hover:bg-muted/50 transition-colors"
                        >
